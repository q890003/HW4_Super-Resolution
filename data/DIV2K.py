...
class div2k(data.Dataset):
    def __init__(self, opt):
        ...
        self.trans_hr = transforms.Compose([transforms.RandomCrop((192,192), pad_if_needed=True, fill=0),
        ...
        self.trans_lr = transforms.Compose([transforms.RandomChoice(self.trans_resizeFromhr),
                                            transforms.ToTensor(),])
